...
public class JdbcMovieDao implements MovieDao {
    ...
    public Iterable<Movie> findAll(MovieRequest movieRequest) {
        ...
        if (genreId.isPresent()) {
            ...
            return jdbcTemplate.query(addSortingIfRequired(currentQuery, movieRequest), movieRowMapper, genreId.get());
        }
        return jdbcTemplate.query(addSortingIfRequired(currentQuery, movieRequest), movieRowMapper);
    }
    ...
    private String addSortingIfRequired(String currentQuery, MovieRequest movieRequest) {
        ...
        if (sortingField.isPresent()) {
            ...
            if (sortingDirection.isPresent()) {
                return currentQuery + " ORDER BY " + sortingField.get() + " " + sortingDirection.get();
            }
        }
        return currentQuery;
    }
